          ...
          <NuxtLink to="/">
            ...
            >
              <svg fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                ...
                />
                <path
                  class="set-svg-stroke" d="M17.4984 17.0781H15.6484" stroke="#292D32" stroke-linecap="round"
                  stroke-linejoin="round" stroke-width="1.5"
                />
                <path
                  class="set-svg-stroke" d="M12.97 17.0781H6.5" stroke="#292D32" stroke-linecap="round"
                  stroke-linejoin="round" stroke-width="1.5"
                />
                <path
                  class="set-svg-stroke" d="M17.4987 13.3203H11.9688" stroke="#292D32" stroke-linecap="round"
                  stroke-linejoin="round" stroke-width="1.5"
                />
                <path
                  class="set-svg-stroke" d="M9.27 13.3203H6.5" stroke="#292D32" stroke-linecap="round"
                  stroke-linejoin="round" stroke-width="1.5"
                />
              </svg>
            </CommonSvgPic>
      ...
      <nav>
                  ...
                  <CommonSvgPic>
                    <svg fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                      <path
                        ...
                        stroke="black" stroke-linecap="round" stroke-miterlimit="10" stroke-width="1.5"
                      />
                      <path
        ...
        <template v-else>
          <CommonSvgPic @click="setSidebarToggle">
            <svg fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
              <path
                class="set-svg-stroke" d="M6 12H18" stroke="#292D32" stroke-linecap="round" stroke-linejoin="round"
                stroke-width="1.5"
              />
              <path d="M12 18V6" stroke="#292D32" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" />
            </svg>
          </CommonSvgPic>
        </template>
      </nav>
