        ...
        nuxt-link(to="/")
          CommonSvgPic(:is-open-hover="!curSidebarShowStatus"
            ...
            svg(width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg")
              ...
              path.set-svg-stroke(d="M12 15.5C13.3807 15.5 14.5 14.3807 14.5 13C14.5 11.6193 13.3807 10.5 12 10.5C10.6193 10.5 9.5 11.6193 9.5 13C9.5 14.3807 10.6193 15.5 12 15.5Z"
                stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round")
          span {{ $t('sidebar-home-text') }}
        ...
        nuxt-link(to="/")
          CommonSvgPic(:is-open-hover="!curSidebarShowStatus"
            ...
            svg(width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg")
              ...
              path.set-svg-stroke(d="M17.4984 17.0781H15.6484" stroke="#292D32" stroke-width="1.5"
                stroke-linecap="round" stroke-linejoin="round")
              path.set-svg-stroke(d="M12.97 17.0781H6.5" stroke="#292D32" stroke-width="1.5"
                stroke-linecap="round" stroke-linejoin="round")
              path.set-svg-stroke(d="M17.4987 13.3203H11.9688" stroke="#292D32" stroke-width="1.5"
                stroke-linecap="round" stroke-linejoin="round")
              path.set-svg-stroke(d="M9.27 13.3203H6.5" stroke="#292D32" stroke-width="1.5"
                stroke-linecap="round" stroke-linejoin="round")
          span {{ $t('sidebar-article-text') }}
          ...
          CommonSvgPic(:is-open-hover="!curSidebarShowStatus"
            ...
            svg(width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg")
              path(d="M9.15859 10.87C9.05859 10.86 8.93859 10.86 8.82859 10.87C6.44859 10.79 4.55859 8.84 4.55859 6.44C4.55859 3.99 6.53859 2 8.99859 2C11.4486 2 13.4386 3.99 13.4386 6.44C13.4286 8.84 11.5386 10.79 9.15859 10.87Z"
                stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round")
              path.set-svg-stroke(d="M16.4112 4C18.3512 4 19.9112 5.57 19.9112 7.5C19.9112 9.39 18.4113 10.93 16.5413 11C16.4613 10.99 16.3713 10.99 16.2812 11"
                stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round")
              path(d="M4.15875 14.56C1.73875 16.18 1.73875 18.82 4.15875 20.43C6.90875 22.27 11.4188 22.27 14.1688 20.43C16.5888 18.81 16.5888 16.17 14.1688 14.56C11.4288 12.73 6.91875 12.73 4.15875 14.56Z"
                stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round")
              path.set-svg-stroke(d="M18.3398 20C19.0598 19.85 19.7398 19.56 20.2998 19.13C21.8598 17.96 21.8598 16.03 20.2998 14.86C19.7498 14.44 19.0798 14.16 18.3698 14"
                stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round")
    ...
    nav
      template(v-if="curSidebarShowStatus")
        div.menu
          ul
            li
              nuxt-link(to="/") {{ $t('sidebar-sitemap-text') }}
            li
              nuxt-link(to="/") {{ $t('sidebar-disclaimer-text') }}
            li
              nuxt-link(to="/") {{ $t('sidebar-privacy-text') }}
        div.link
          ul
            li
              nuxt-link(to="/")
            ...
            li
              nuxt-link(to="/")
                CommonSvgPic
                  svg(width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg")
                    path.set-svg-stroke(d="M16.1594 10C16.1594 10 16.0094 11 12.9094 15C9.99941 18.77 14.2095 21.64 14.7095 21.97C14.7395 21.99 14.7694 21.99 14.8094 21.97C15.4894 21.55 23.0594 16.68 16.1594 10Z"
                      stroke="black" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
