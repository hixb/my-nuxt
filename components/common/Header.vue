        ...
        <div class="area-func">
          ...
          <CommonSvgPic @click="setLocale(locale === 'en' ? 'zh-CN' : 'en')">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              />
              <path
                d="M15.1719 17.9102H18.6919" stroke="#292D32" stroke-width="1.5" stroke-linecap="round"
                stroke-linejoin="round"
              />
              <path
              ...
              />
              <path
                d="M9.01312 5.85156H4.95312" stroke="#292D32" stroke-width="1.5" stroke-linecap="round"
                stroke-linejoin="round"
              />
              <path
                d="M6.97266 5.17188V5.85187" stroke="#292D32" stroke-width="1.5" stroke-linecap="round"
                stroke-linejoin="round"
              />
              <path
              ...
              />
              <path
                d="M9.01015 9.01001C8.28015 9.01001 7.62016 8.62 7.16016 8" stroke="#292D32" stroke-width="1.5"
                stroke-linecap="round" stroke-linejoin="round"
              />
              <path
                class="set-svg-stroke" d="M2 15C2 18.87 5.13 22 9 22L7.95 20.25" stroke="#292D32" stroke-width="1.5"
                stroke-linecap="round" stroke-linejoin="round"
              />
              <path
                class="set-svg-stroke" d="M22 9C22 5.13 18.87 2 15 2L16.05 3.75" stroke="#292D32" stroke-width="1.5"
                stroke-linecap="round" stroke-linejoin="round"
              />
            </svg>
          </CommonSvgPic>
          <CommonSvgPic @click="setThemeMode">
            ...
            <svg
              v-show="currentTheme == 'dark-mode'" width="24" height="24" viewBox="0 0 24 24" fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
